...
.LM14:
	...
	movq	%rax, 8(%rsp)
	xorl	%eax, %eax
	.stabn	68,0,29,.LM15-.LFBB2
.LM15:
	call	memset@PLT
	.stabn	68,0,33,.LM16-.LFBB2
.LM16:
	call	cons_init@PLT
	.stabn	68,0,35,.LM17-.LFBB2
.LM17:
	leaq	.LC2(%rip), %rdi
	movl	$6828, %esi
	xorl	%eax, %eax
...
.LFB2:
	...
	movaps	%xmm7, 192(%rsp)
.L12:
	.stabn	68,0,65,.LM25-.LFBB3
.LM25:
	movq	%fs:40, %rax
	movq	%rax, 24(%rsp)
	xorl	%eax, %eax
	.stabn	68,0,68,.LM26-.LFBB3
.LM26:
	cmpq	$0, panicstr(%rip)
	je	.L17
	.p2align 4,,10
...
.LM32:
	...
	leaq	32(%rsp), %rax
	movq	%rax, 16(%rsp)
	.stabn	68,0,76,.LM33-.LFBB3
.LM33:
	xorl	%eax, %eax
	call	cprintf@PLT
	.stabn	68,0,77,.LM34-.LFBB3
.LM34:
	movq	%rbx, %rdi
	movq	%rsp, %rsi
	call	vcprintf@PLT
	.stabn	68,0,78,.LM35-.LFBB3
.LM35:
	leaq	.LC6(%rip), %rdi
	xorl	%eax, %eax
	call	cprintf@PLT
...
.LM40:
	...
	movl	$48, 4(%rsp)
	movq	%rax, 16(%rsp)
	.stabn	68,0,94,.LM41-.LFBB4
.LM41:
	xorl	%eax, %eax
	call	cprintf@PLT
	.stabn	68,0,95,.LM42-.LFBB4
.LM42:
	movq	%rsp, %rsi
	movq	%rbx, %rdi
	call	vcprintf@PLT
